...
public class TestCase4 {
	...
	public void setUp() throws Exception {
	  ...
	  public void testTestCase4() throws Exception {
	    ...
	    driver.findElement(By.xpath("//ul[@class='products-grid products-grid--max-4-col first last odd']//li[2]//div[1]//div[3]//ul[1]//li[2]//a[1]")).click();
	    String mainMobile1 = driver.findElement(By.xpath("//a[contains(text(),'IPhone')]")).getText();  // text captured - upperCase "IPHONE"
	    System.out.println("mainMobile1 = "+mainMobile1);
	    Thread.sleep(1000);
	    driver.findElement(By.xpath("//ul[@class='products-grid products-grid--max-4-col first last odd']//li[1]//div[1]//div[3]//ul[1]//li[2]//a[1]")).click();   
	    String mainMobile2 = driver.findElement(By.xpath("//a[@title='Sony Xperia'][contains(text(),'Sony Xperia')]")).getText();  // text captured - upperCase "SONY XPERIA"
